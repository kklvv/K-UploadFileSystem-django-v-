...
angular.module('pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            ...
            'the<input type="text" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)"/>page ' +
            'per page<select ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions "></select>' +
